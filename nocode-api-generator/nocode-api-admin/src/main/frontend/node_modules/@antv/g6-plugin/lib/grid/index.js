...
var Grid = /** @class */function (_super) {
  ...
  Grid.prototype.init = function () {
    ...
    var container = (0, _domUtil.createDom)("<div class='g6-grid-container' style=\"position:absolute;overflow:hidden;z-index: -1;\"></div>");
  ...
  Grid.prototype.positionInit = function () {
    ...
    (0, _domUtil.modifyCSS)(this.get('container'), {
    ...
    (0, _domUtil.modifyCSS)(this.get('gridContainer'), {
