...
var TimeBarSlice = /** @class */function () {
  ...
  TimeBarSlice.prototype.renderSlices = function () {
    ...
    data.forEach(function (d, i) {
      ...
      if (label) {
        ...
        if ((0, _util.isNumber)(rotate) && labels.length !== 10) {
  ...
  TimeBarSlice.prototype.initEvent = function () {
    ...
    // 播放区按钮控制
    /** 播放/暂停事件 */
    group.on("".concat(_constant.PLAY_PAUSE_BTN, ":click"), function () {
      _this.isPlay = !_this.isPlay;
      _this.changePlayStatus();
    });
    // 处理前进一步的事件
    group.on("".concat(_constant.NEXT_STEP_BTN, ":click"), function () {
      _this.updateStartEnd(1);
    });
    // 处理后退一步的事件
    group.on("".concat(_constant.PRE_STEP_BTN, ":click"), function () {
      _this.updateStartEnd(-1);
    });
...
var _default = exports.default = TimeBarSlice;